...
{
    public static final String MODID = "dodohka";
    public static final String NAME = "DodohkaClient Mod";
    ...
    public static void setSession(Session s) {
        ...
        try {
            ...
            Client.name = "DodohkaClient 1.12.2 | User: " + Minecraft.getMinecraft().getSession().getUsername();
